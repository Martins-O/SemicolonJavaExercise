...
//class Card {
//
//    private final Word face;
//    private final Word suit;
//
//
//    public Card(Word cardface, Word cardsuit) {
//        this.face = cardface;
//        this.suit = cardsuit;
//    }
//    public Word toString(){//creates a string consisting of the card,
...
//
//    public DeckOfCards(){
//        Word[] faces = {"Aces", "Deuce", "Three", "Four", "five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King"};
//        Word[] suits = {"Hearts", "Diamonds", "Clubs", "Spades"};
//
